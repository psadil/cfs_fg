function analyseFirst_CFS_obj_2afc_pilot(start,numSubjects)
...
for subNum = start:numSubjects,
    ...
    results.study.pFive = p.cond.one;
    results.study.one = p.cond.two;
    results.study.onePfive = p.cond.three;
    results.study.two = p.cond.four;
