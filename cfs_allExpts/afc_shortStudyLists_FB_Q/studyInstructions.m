...
presentStudyStim(p,1,p.texture_ITI,[0,0],texAlpha)
...
if p.rightEyeDom
    presentStudyStim(p,1,texture_wholeObject,[1,2],texAlpha)
else
    presentStudyStim(p,1,texture_wholeObject,[2,1],texAlpha)
end
