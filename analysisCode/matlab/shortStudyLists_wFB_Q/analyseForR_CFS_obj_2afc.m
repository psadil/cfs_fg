...
%                 temp = p.responses.study(studyInd);
                ...
                if all(p.responses.study(studyInd,1:2)=='n3')
                    temp = 1;
                elseif all(p.responses.study(studyInd,1:2)=='n2')
                    temp = 2;
                elseif all(p.responses.study(studyInd,1:2)=='n1')
                    temp = 3;
                elseif all(p.responses.study(studyInd,1:2)=='n0')
                    temp = 4;
                elseif all(p.responses.study(studyInd,1:2)=='y0')
                    temp = 5;
                elseif all(p.responses.study(studyInd,1:2)=='y1')
                    temp = 6;
                elseif all(p.responses.study(studyInd,1:2)=='y2')
                    temp = 7;
                elseif all(p.responses.study(studyInd,1:2)=='y3')
                    temp = 8;
                else
                    temp=0;
                end
    ...
    outPut(1:p.nItems.unique,:) = [sub_subject', sub_condition, sub_pasResp, sub_pasResp2, sub_named', afcCorrect, whichItem, testTrial'];
