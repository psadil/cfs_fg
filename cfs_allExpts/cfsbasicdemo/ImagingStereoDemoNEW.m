function ImagingStereoDemoNEW(stereoMode, usedatapixx, writeMovie)
...
PsychImaging('AddTask', 'LeftView', 'StereoCrosstalkReduction', 'SubtractOther', [161 161 161])
...
% Screen('OpenWindow'):
[windowPtr, windowRect] = PsychImaging('OpenWindow', scrnNum, .9, [], [], [], 1);
% [161, 161, 161]
