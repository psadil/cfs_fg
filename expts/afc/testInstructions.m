...
text_First3 = 'SECOND, you will be asked to name an object to which one of those parts belongs.';
...
text_Fourth2 = 'If you remember that this is a part of a longboard, ANSWER: light switch.';
...
[a1, mapCol, transperancy] = imread(filename1a, 'background', 'none');
[a2, mapCol, transperancy] = imread(filename2a, 'background', 'none');
[b3, mapCol, transperancy] = imread(filename3b, 'background', 'none');

imLeft = a1+a2;
imRight = a1+b3;
textureLeft = Screen('MakeTexture',p.window, imLeft);
textureRight = Screen('MakeTexture',p.window, imRight);
...
while 1,
    ...
    Screen('DrawTexture',p.window,p.whiteTex,[],p.whiteRect-[650, 0, 50, 0]);
    Screen('DrawTexture',p.window,p.greyTex,[],p.greyRect-[650, 0, 50, 0]);
    Screen(p.window,'DrawTexture', textureLeft, [], p.imageRect-[650, 0, 50, 0]);
    
    Screen('DrawTexture',p.window,p.whiteTex,[],p.whiteRect+[50, 0, 650, 0]);
    Screen('DrawTexture',p.window,p.greyTex,[],p.greyRect+[50, 0, 650, 0]);
    Screen(p.window,'DrawTexture', textureRight, [], p.imageRect-[650, 0, 50, 0]);
