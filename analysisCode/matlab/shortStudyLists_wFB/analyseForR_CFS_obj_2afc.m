...
for subNum = firstSub:lastSub
    ...
    fileName = [pwd '\subjectData\scored\Subject' num2str(subNum) 'CFS_obj_2AFC_ss1_wFB_scored_noCheck.mat'];
    load(fileName)
...
fileName = [pwd,'\subjectData\exported\cfs_obj_2afc_ss1_wFB_noCheck.dat'];
