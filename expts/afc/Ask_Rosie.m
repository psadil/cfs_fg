...
while 1
    ...
    elseif rosie.test == 1
        ...
        Screen('DrawTexture',window,rosie.whiteTex,[],rosie.whiteRect-[650, 0, 50, 0]);
        Screen('DrawTexture',window,rosie.greyTex,[],rosie.greyRect-[650, 0, 50, 0]);
        Screen('DrawTexture',window, rosie.imLeft,[],rosie.imageRect-[650, 0, 50, 0]);
        
        Screen('DrawTexture',window,rosie.whiteTex,[],rosie.whiteRect-[650, 0, 50, 0]);
        Screen('DrawTexture',window,rosie.greyTex,[],rosie.greyRect-[650, 0, 50, 0]);
        Screen('DrawTexture',window, rosie.imRight,[],rosie.imageRect-[650, 0, 50, 0]);
