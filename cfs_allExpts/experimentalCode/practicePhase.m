...
%text to display
text_beginPrac = 'You will first complete a short version of the test as practice. This practice will look exactly like the full experiment, but with fewer items to remember. Feel free to grab the experimenter if you have any questions.';
...
if p.studyPhase
    [~] = studyPhase(p, trialsPracticeStudy);
end
