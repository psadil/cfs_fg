...
dataFile <- paste(wd, "/cfs_obj_2afc_g100.dat", sep="")
...
# par(mfrow=c(1,1))
# 
# # collect mean recal rate for each condition, for each PAS
...
# 
# 
# # look at recal rates broken up by pas, across all conditions,
