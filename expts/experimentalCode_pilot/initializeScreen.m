...
p.texAlpha = table([0:20:80, ones(1,5)*100, 80:-20:0], ...
    [0:20:80, ones(1,10)*100, 80:-20:0], ...
    [0:20:80, ones(1,15)*100, 80:-20:0], ...
    [0:20:80, ones(1,20)*100, 80:-20:0]);
...
p.texAlpha.Properties.VariableNames{'Var1'} = 'secs_one_five';
p.texAlpha.Properties.VariableNames{'Var2'} = 'secs_two';
p.texAlpha.Properties.VariableNames{'Var3'} = 'secs_two_five';
p.texAlpha.Properties.VariableNames{'Var4'} = 'secs_three';
