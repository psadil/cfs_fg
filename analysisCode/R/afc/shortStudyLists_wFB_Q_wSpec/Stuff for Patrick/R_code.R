...
index_i = data$whichItem

#index_s = rep( 1:Ns, each = Ni )
index_s = data$subject
...
# not sure whether this should the be correct response, or whether the response given was correct...
# going with the ground truth correct side
Correct = data$whichSide
