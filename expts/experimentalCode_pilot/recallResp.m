function [p] = recallResp( p, texture, trial, inclusion )
...
if inclusion
    ...
    rosie.text1 = 'Please name an object that this could be part of. REMEMBER, if you''ve seen this before, name a different object. Otherwise, guess.';
end
