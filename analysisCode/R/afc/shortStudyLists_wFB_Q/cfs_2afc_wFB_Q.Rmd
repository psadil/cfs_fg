...
setwd("C:/Users/admin/googleDrive/uMass/firstYear/behavioralExpts/pSadil/processDissociation/CFS/cfs_fg/analysisCode/R/afc/shortStudyLists_wFB_Q")
wd <- getwd()
...
data <- inner_join(x=data_test,y=data_study, by=c('whichItem','subject')) %>%
  ...
  mutate(., pas1 = studyResp, pas2 = studyResp2)

# make PAS rating out of study responses
data[data$studyResp==1,]$pas1 = 3
data[data$studyResp==8,]$pas1 = 3
data[data$studyResp==2,]$pas1 = 2
data[data$studyResp==7,]$pas1 = 2
data[data$studyResp==3,]$pas1 = 1
data[data$studyResp==6,]$pas1 = 1
data[data$studyResp==4,]$pas1 = 0
data[data$studyResp==5,]$pas1 = 0


data[data$studyResp2==1,]$pas2 = 3
data[data$studyResp2==8,]$pas2 = 3
data[data$studyResp2==2,]$pas2 = 2
data[data$studyResp2==7,]$pas2 = 2
data[data$studyResp2==3,]$pas2 = 1
data[data$studyResp2==6,]$pas2 = 1
data[data$studyResp2==4,]$pas2 = 0
# data[data$studyResp2==5,]$pas2 = 0
